...
FP rate on 1d is tiny. They tend to happen with tiny dividends e.g. 0.5%, mistaking normal price volatility for an ex-div drop 100x bigger than the dividend, and repairing the "too small" dividend. Fetching 1-2 years of prices with at least 3 dividends helps a lot - can analyse the dividends together to identify false positives.
